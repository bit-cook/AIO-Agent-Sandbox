...
<p align="center">
  <img src="website/docs/public/aio-icon.png" alt="AIO Sandbox Logo" width="200"/>
</p>
...
# Use with OpenAI Assistant API
assistant = client.beta.assistants.create(
    name="Sandbox Assistant",
    tools=[{"type": "function", "function": create_sandbox_function()}]
)
```

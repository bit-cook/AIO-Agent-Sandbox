...
# Execute Python code
result = client.jupyter.execute_jupyter_code(
    code="""
import numpy as np
...
result1 = client.jupyter.execute_jupyter_code(
    code="x = 42\ny = 'Hello'",
    session_id="my_session"
)

# Second execution - use previous variables
result2 = client.jupyter.execute_jupyter_code(
...
result_py39 = client.jupyter.execute_jupyter_code(
    code="""
import sys
...
result_py311 = client.jupyter.execute_jupyter_code(
    code="""
import sys
print(f"Python: {sys.version}")
...
result_py312 = client.jupyter.execute_jupyter_code(
    code="""
import sys
print(f"Python: {sys.version}")
...
```python
result = client.jupyter.execute_jupyter_code(code="...")
...
- Learn about [File Operations](./file-operations) for managing files in the sandbox
- Explore [Shell Execution](./shell-execution) for running system commands
- Check out [Browser Automation](./browser-automation) for web testing and scraping
